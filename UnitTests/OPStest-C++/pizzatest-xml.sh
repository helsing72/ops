...
exit_gtest=$?
build.debug/UnitTests/OPStest-C++/gtest/gtest-mempool --gtest_output="xml:unittest-c++-gtest-mp-result.xml"
exit_gtest_mp=$?
build.debug/UnitTests/OPStest-C++/gtest/gtest-mempool3 --gtest_output="xml:unittest-c++-gtest-mp-result.xml"
exit_gtest_mp3=$?

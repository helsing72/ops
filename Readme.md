...
Presently OPS is available in Java (Windows, Linux, Unix, Mac), C++ (Windows, Linux), C# (Windows) and Delphi (Object Pascal) programming languages. Experimental support exist for Python 2.7. OPS can also be used under Matlab through the Java Matlab bridge available with Matlab.

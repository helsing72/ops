...
-- ==========================================================================
  ...
  procedure Serialize( Self : in out Channel_Class; archiver : ArchiverInOut_Class_At);

  -- Returns a newely allocated deep copy/clone of this object.
  function Clone( Self : Channel_Class ) return OpsObject_Class_At;

  -- Fills the parameter obj with all values from this object.
  procedure FillClone( Self : Channel_Class; obj : OpsObject_Class_At );
...
-- ==========================================================================
  ...
  --------------------------------------------------------------------------
  procedure Finalize( Self : in out Channel_Class );
